  ...
  const metrics: Metric[] = [
    {
      ...
      description: "Handling millions of requests with sub-200ms latency",
    ...
    },
    {
      ...
      suffix: "%",
      label: "System Uptime",
      description: "Production systems running at enterprise-grade reliability",
    ...
    },
    {
      ...
      suffix: "+",
      label: "Active Users",
      description: "Real users benefiting from intelligent systems",
    ...
    },
    {
      ...
      description: "Optimization improvements across production systems",
    ...
    },
    {
      ...
      description: "Lightning-fast API responses under heavy load",
      color: "from-cyan-400 to-blue-500",
      icon: "⏱️",
    },
  ];
